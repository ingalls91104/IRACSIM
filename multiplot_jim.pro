...
;                    [,xshift=xshift] [,yshift=yshift] [,position=position] [,nremain=nremain]
; Examples:
...
;       nremain = number of remaining plots (like first element of !p.multi, controls which plots to do)
...
pro multiplot_jim,help=help,pmulti $
                  ...
                  xsqueeze=xsqueeze,ysqueeze=ysqueeze,xshift=xshift,yshift=yshift,nremain=nremain
;
;       =====>> COMMON
;
common multiplot $
...
rows = nplots[1]
;; JIM ADDITION query
nleft = KEYWORD_SET(nremain) ? nremain : nleft - 1                       ; decrement plots remaining
;;;
